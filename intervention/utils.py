"""Device selection and seeding, vendored from the parent SWP project.

Kept byte-for-byte equivalent so runs reproduce across the two repos: the seeding order
(python `random`, then numpy, then torch) is what makes a given seed reproduce a given
dataset split and initialisation.
"""
